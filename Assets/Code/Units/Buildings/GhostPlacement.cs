...
namespace Code.Units.Buildings
{
    public class GhostPlacement : MonoBehaviour
    {
        ...
        [SerializeField, ColorUsage(true, true)] private Color errorFresnelColor = new Color(4f, 1.7f, 0, 1);
        [SerializeField, ColorUsage(true, true)] private Color availableTintColor = new Color(0.2f, 0.65f, 1, 1);
        [SerializeField, ColorUsage(true, true)] private Color availableFresnelColor = new Color(0.8f, 1.5f, 2.2f, 1);
